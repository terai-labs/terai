		...
		>
			...
			>
				...
				>
					...
					>
						<a href='/terai/docs' style={{ textDecoration: 'none' }}>
							<button
								type='button'
								style={{
									color: 'white',
							...
							{[
								{
									...
									icon: '💻',
									color: '#a788ec',
									// biome-ignore lint/suspicious/noTemplateCurlyInString: <explanatione>
...
function ModernWorkflowStep({
	...
	return (
		// biome-ignore lint/a11y/noStaticElementInteractions: <explanationy
		<div
			style={{
				display: 'flex',
				flexDirection: 'column',
...
function FeatureCard({ icon, title, description, gradient }: any) {
	...
	return (
		// biome-ignore lint/a11y/noStaticElementInteractions: <explanatione>
		<div
			className='nx-bg-white dark:nx-bg-neutral-900'
			style={{
				display: 'flex',
		...
		>
			...
			<div
				style={{
					...
					maskImage:
						'radial-gradient(ellipse 80% 50% at 50% 40%, black 40%, transparent 100%)'
				}}
			...
			<div
				style={{
					...
					backgroundSize: '80px 80px',
					maskImage:
						'radial-gradient(ellipse 60% 40% at 50% 30%, black, transparent 70%)'
				}}
			/>
			...
			<div
				style={{
					...
					borderRadius: '50%',
					background:
						'radial-gradient(circle, rgba(167, 136, 236, 0.08) 0%, transparent 70%)',
					filter: 'blur(60px)',
					pointerEvents: 'none'
				}}
			/>
			<div
				style={{
					...
					borderRadius: '50%',
					background:
						'radial-gradient(circle, rgba(255, 137, 0, 0.08) 0%, transparent 70%)',
					filter: 'blur(60px)',
					pointerEvents: 'none'
				}}
			/>
