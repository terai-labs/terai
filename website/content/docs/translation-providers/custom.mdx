---
title: Custom
description: Learn how to use a custom translator with Terai to handle translations in your project.
---
...
With this setup, every time you run `terai translate`, Terai will call your custom translator function to translate the dictionary to the desired locales.
