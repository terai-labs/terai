---
title: setupTerai
description: Main function to be called to configure runtime options for Terai.
---

<Callout type='info' emoji='ℹ️'>
It should be called only once (ideally, at the entry point of your application).
</Callout>
