---
title: Usage
description: Learn how to integrate Terai into your Node project
---
...
- [`setup`](/docs/node/references/setup-terai): Configuration function that returns `getTs` and `getFormat`.
...
- [`getTs`](/docs/node/references/get-ts): Function to get the translation function.
...
- [`setup`](/docs/node/references/setup-terai): Configuration function that returns `getTs` and `getFormat`.
- [`getTs`](/docs/node/references/get-ts): Function to get the translation function.
- [`getFormat`](/docs/node/references/get-format): Function to get the format function.
