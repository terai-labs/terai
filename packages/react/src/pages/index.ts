...
export function createI18n<
  ...
  OtherLocales extends ExplicitLocales | null = null
>(locales: Locales) {
  type TempLocale = OtherLocales extends ExplicitLocales
    ? GetLocaleType<OtherLocales>
    : GetLocaleType<Locales>
  type Locale = TempLocale extends Record<string, string>
    ? TempLocale
    : FlattenLocale<TempLocale>

  type LocalesKeys = OtherLocales extends ExplicitLocales
    ? keyof OtherLocales
    : keyof Locales
